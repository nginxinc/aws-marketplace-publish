...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.resolveHttpAuthSchemeConfig = exports.defaultMarketplaceCatalogHttpAuthSchemeProvider = exports.defaultMarketplaceCatalogHttpAuthSchemeParametersProvider = void 0;
...
exports.defaultMarketplaceCatalogHttpAuthSchemeParametersProvider = defaultMarketplaceCatalogHttpAuthSchemeParametersProvider;
...
exports.defaultMarketplaceCatalogHttpAuthSchemeProvider = defaultMarketplaceCatalogHttpAuthSchemeProvider;
...
var import_httpAuthSchemeProvider = __nccwpck_require__(9221);
...
var _MarketplaceCatalogClient = class _MarketplaceCatalogClient extends import_smithy_client.Client {
  ...
  getDefaultHttpAuthSchemeParametersProvider() {
    return import_httpAuthSchemeProvider.defaultMarketplaceCatalogHttpAuthSchemeParametersProvider;
  }
...
const httpAuthSchemeProvider_1 = __nccwpck_require__(9221);
...
const getRuntimeConfig = (config) => {
    return {
        ...
        httpAuthSchemeProvider: config?.httpAuthSchemeProvider ?? httpAuthSchemeProvider_1.defaultMarketplaceCatalogHttpAuthSchemeProvider,
        httpAuthSchemes: config?.httpAuthSchemes ?? [
            {
                schemeId: "aws.auth#sigv4",
...
var _v = _interopRequireDefault(__nccwpck_require__(3802));

var _v2 = _interopRequireDefault(__nccwpck_require__(9450));

var _v3 = _interopRequireDefault(__nccwpck_require__(6475));

var _v4 = _interopRequireDefault(__nccwpck_require__(959));

var _nil = _interopRequireDefault(__nccwpck_require__(4021));

var _version = _interopRequireDefault(__nccwpck_require__(5943));

var _validate = _interopRequireDefault(__nccwpck_require__(722));

var _stringify = _interopRequireDefault(__nccwpck_require__(3659));

var _parse = _interopRequireDefault(__nccwpck_require__(887));
...
var _rng = _interopRequireDefault(__nccwpck_require__(5446));

var _stringify = __nccwpck_require__(3659);
...
var _v = _interopRequireDefault(__nccwpck_require__(3383));

var _md = _interopRequireDefault(__nccwpck_require__(5359));
...
var _native = _interopRequireDefault(__nccwpck_require__(3671));
...
var _sha = _interopRequireDefault(__nccwpck_require__(5889));
...
var _regex = _interopRequireDefault(__nccwpck_require__(9135));
...
"use strict";
module.exports = JSON.parse('{"name":"@aws-sdk/client-sts","description":"AWS SDK for JavaScript Sts Client for Node.js, Browser and React Native","version":"3.565.0","scripts":{"build":"concurrently \'yarn:build:cjs\' \'yarn:build:es\' \'yarn:build:types\'","build:cjs":"node ../../scripts/compilation/inline client-sts","build:es":"tsc -p tsconfig.es.json","build:include:deps":"lerna run --scope $npm_package_name --include-dependencies build","build:types":"rimraf ./dist-types tsconfig.types.tsbuildinfo && tsc -p tsconfig.types.json","build:types:downlevel":"downlevel-dts dist-types dist-types/ts3.4","clean":"rimraf ./dist-* && rimraf *.tsbuildinfo","extract:docs":"api-extractor run --local","generate:client":"node ../../scripts/generate-clients/single-service --solo sts","test":"yarn test:unit","test:unit":"jest"},"main":"./dist-cjs/index.js","types":"./dist-types/index.d.ts","module":"./dist-es/index.js","sideEffects":false,"dependencies":{"@aws-crypto/sha256-browser":"3.0.0","@aws-crypto/sha256-js":"3.0.0","@aws-sdk/core":"3.556.0","@aws-sdk/credential-provider-node":"3.565.0","@aws-sdk/middleware-host-header":"3.535.0","@aws-sdk/middleware-logger":"3.535.0","@aws-sdk/middleware-recursion-detection":"3.535.0","@aws-sdk/middleware-user-agent":"3.540.0","@aws-sdk/region-config-resolver":"3.535.0","@aws-sdk/types":"3.535.0","@aws-sdk/util-endpoints":"3.540.0","@aws-sdk/util-user-agent-browser":"3.535.0","@aws-sdk/util-user-agent-node":"3.535.0","@smithy/config-resolver":"^2.2.0","@smithy/core":"^1.4.2","@smithy/fetch-http-handler":"^2.5.0","@smithy/hash-node":"^2.2.0","@smithy/invalid-dependency":"^2.2.0","@smithy/middleware-content-length":"^2.2.0","@smithy/middleware-endpoint":"^2.5.1","@smithy/middleware-retry":"^2.3.1","@smithy/middleware-serde":"^2.3.0","@smithy/middleware-stack":"^2.2.0","@smithy/node-config-provider":"^2.3.0","@smithy/node-http-handler":"^2.5.0","@smithy/protocol-http":"^3.3.0","@smithy/smithy-client":"^2.5.1","@smithy/types":"^2.12.0","@smithy/url-parser":"^2.2.0","@smithy/util-base64":"^2.3.0","@smithy/util-body-length-browser":"^2.2.0","@smithy/util-body-length-node":"^2.3.0","@smithy/util-defaults-mode-browser":"^2.2.1","@smithy/util-defaults-mode-node":"^2.3.1","@smithy/util-endpoints":"^1.2.0","@smithy/util-middleware":"^2.2.0","@smithy/util-retry":"^2.2.0","@smithy/util-utf8":"^2.3.0","tslib":"^2.6.2"},"devDependencies":{"@smithy/service-client-documentation-generator":"^2.2.0","@tsconfig/node14":"1.0.3","@types/node":"^14.14.31","concurrently":"7.0.0","downlevel-dts":"0.10.1","rimraf":"3.0.2","typescript":"~4.9.5"},"engines":{"node":">=14.0.0"},"typesVersions":{"<4.0":{"dist-types/*":["dist-types/ts3.4/*"]}},"files":["dist-*/**"],"author":{"name":"AWS SDK for JavaScript Team","url":"https://aws.amazon.com/javascript/"},"license":"Apache-2.0","browser":{"./dist-es/runtimeConfig":"./dist-es/runtimeConfig.browser"},"react-native":{"./dist-es/runtimeConfig":"./dist-es/runtimeConfig.native"},"homepage":"https://github.com/aws/aws-sdk-js-v3/tree/main/clients/client-sts","repository":{"type":"git","url":"https://github.com/aws/aws-sdk-js-v3.git","directory":"clients/client-sts"}}');
